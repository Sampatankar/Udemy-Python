"""
INSTRUCTIONS:
1. Create three files from each JSON data commented below.
2. Note where they are on your machine and load them up
  under additional options menu.
3. Load the code below into the Python Code box.
4. Watch as the code fulfills all three different worlds
  created from each of the three JSON files.
"""
...
# # JSON 1 - Save as 'problem_world.json':
#     {
#   "walls": {
#     "1,1": [
#       "east"
...
# # JSON 2 - Save as 'problem_world2.json':
#     {
#   "walls": {
#     "1,1": [
#       "east"
...
# # JSON 3 - Save as 'problem_world3.json':
#     {
#   "walls": {
#     "1,1": [
#       "east"
